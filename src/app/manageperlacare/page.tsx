...
const ManagePerLaCare: React.FC = () => {
  ...
  return (
    <Box sx={{}}>
      ...
      <Grid sx={{ padding: { xs: "5%", sm: "5%", lg: "123px 116px" } }}>
              ...
              <Grid item lg={7} xs={12} sm={7}>
                ...
                <Typography
                  sx={{
                    ...
                    lineHeight: { xs: "18px", sm: "25px", lg: "1.5" },
                    paddingTop: "33px",
                    whiteSpace: "pre-line",
                  }}
                >
        ...
        >
          ...
          <Grid
            sx={{
              ...
              backgroundRepeat: "no-repeat",
              marginTop: { xs: "0px", sm: "0px", lg: "107px" },
            }}
          >
              ...
              >
                <Typography
                  sx={{
                    ...
                    lineHeight: "auto",
                    letterSpacing: "0%",
                    fontSize: { xs: "16px", sm: "20px", lg: "32px" },
                  }}
                  component="div"
                >
                ...
                <Typography
                  sx={{
                    ...
                    fontStyle: "italic",
                    marginTop: "24px",
                    fontSize: { xs: "10px", sm: "14px", lg: "19.5px" },
                  }}
                  color="textSecondary"
                >
      ...
      <Grid container>
        <Grid
          sx={{
            margin: { xs: "0px", sm: "0px", lg: "90px 359px 153px 359px" },
          }}
        >
          <Grid
            item
          ...
          <Grid
            item
            lg={12}
            sx={{ marginTop: { xs: "30px", sm: "30px", lg: "162px" } }}
          >
            <Typography
              sx={{
                textAlign: "center",
            ...
            >
              <Grid
                ...
                lg={6}
                sx={{
                  height: { xs: "0px", sm: "390px", lg: "490px" },
                  overflowY: "auto",
                  scrollbarWidth: "thin",
                }}
              >
          ...
          <Grid item lg={12}>
            <Typography
              sx={{
                ...
                fontSize: { xs: "30px", sm: "40px", lg: "50px" },
                fontWeight: 400,
                marginTop: { xs: "50px", sm: "50px", lg: "269px" },
                letterSpacing: "1%",
                fontFamily: "Mulish",
                lineHeight: "150%",
              }}
      ...
      >
        <Grid
          sx={{
            ...
            alignItems: "center",
            // marginTop: "10%",
            margin: { xs: "10%", sm: "10%", lg: "107px 522px" },
            flexDirection: "column",
          }}
        >
          {managePage.map((post: any) => (
              ...
              <div>
                <Typography
                  sx={{
                    ...
                    textAlign: "center",
                    padding: { xs: "12%", sm: "12%", lg: "0px 82px 34px 82px" },
                    letterSpacing: "2%",
                  }}
                >
              ...
              <div>
                <Typography
                  sx={{
                    ...
                    textAlign: "center",
                    letterSpacing: "1%",
                    padding: { lg: "0px 303px 78px 303px" },
                  }}
                >
