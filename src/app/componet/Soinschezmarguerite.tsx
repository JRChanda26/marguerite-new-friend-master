...
const Soinschezmarguerite: React.FC = () => {
    ...
    return (
        <Box>
                    ...
                    <Grid container spacing={2} >
                        <Grid item lg={12} style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', gap: '10px' }}>
                            <Grid item lg={3}>
                                ...
                                <div style={{ display: 'flex', flexDirection: 'row', paddingTop: '52px', justifyContent: 'center', alignItems: 'center' }}>
                                    <Button style={{
                                        fontFamily: 'Mulish',
                                        fontSize: '18px',
                                        fontWeight: 600,
                                    ...
                                    <img
                                        ...
                                        style={{ width: "15.14px", height: "13.18px", paddingLeft: '26.02px' }}
                                    />
                                </div>
                            </Grid>
                            <Grid item lg={3}>
                                ...
                                <div style={{
                                    display: 'flex', flexDirection: 'row', paddingTop: '52px', justifyContent: 'center', alignItems: 'center'
                                }}>
                                    <Button style={{
                                        fontFamily: 'Mulish',
                                        fontSize: '18px',
                            ...
                            <Grid item lg={3}>
                                ...
                                <div style={{ display: 'flex', flexDirection: 'row', paddingTop: '73px', justifyContent: 'center', alignItems: 'center' }}>
                                    <Button style={{
                                        fontFamily: 'Mulish',
                                        fontSize: '18px',
                                        fontWeight: 600,
            ...
            <div style={{
                background: `url(${backgroundpeople})`, backgroundSize: "cover",
                width: "auto",
                height: "auto",
                paddingTop: '187.05px'
            }}>
                                ...
                                <Grid item lg={3} >
                                    <div style={{ background: '#FFFFFF', height: '433px', width: '283.55px', borderRadius: '30px' }}>
                                        <div>
                                            ...
                                            <div style={{ display: 'flex', flexDirection: 'row', paddingTop: '65.53px', justifyContent: 'center' }}>
                                                <img
                                                    src={post.data.facebook?.url || ""}
                                                    alt={post.data.facebook?.alt || "icon"}
                                                    style={{ width: "7.9px", height: "21.03px", paddingRight: '36.85px' }}
                                                />
                                                <img
                                                    src={post.data.twitter?.url || ""}
                                                    alt={post.data.twitter?.alt || "icon"}
                                                    style={{ width: "11.84px", height: "21.03px", paddingRight: '33.56px' }}
                                                />
                                                <img
                                                    src={post.data.linkedin?.url || ""}
                                                    alt={post.data.linkedin?.alt || "icon"}
                                                    style={{ width: "10.53px", height: "21.03px", paddingRight: '35.53px' }}
                                                />
                                                <img
