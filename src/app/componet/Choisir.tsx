                ...
                <div style={{ height: '476px', width: '402px', borderRadius: '16px', background: 'linear-gradient(180.79deg, #FFFFFF 7.81%, rgba(187, 221, 217, 0.6) 205.96%)', marginTop: '40px',paddingBottom:'34px' }}>
                    {posts.map((post: any, postIndex: number) => (
                        <>
                            ...
                            <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', paddingTop: '21px' }}>
                            <Typography style={{color:'#24535C',fontWeight:400,fontSize:'14px',lineHeight:'25.9px',paddingRight:'12px'}}>
                ...
                <div style={{ height: '575.83px', width: '486.31px', borderRadius: '16px', background: 'linear-gradient(180.23deg, #FFFFFF 7.39%, #FFFFFF 45.36%, #FFB699 193.52%)', }}>
                    {posts.map((post: any, postIndex: number) => (
                        <>
                            ...
                            <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', paddingTop: '44.76px' }}>
                                <Typography style={{color:'#24535C',fontWeight:400,fontSize:'16.94px',lineHeight:'31.33px',paddingRight:'14.31px'}}>
                                    {post.data.buttontext}
                                </Typography>
                                <img
                                    src={post.data.buttonicon?.url || ''}
