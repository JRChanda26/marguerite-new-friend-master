...
const Choisir: React.FC = () => {
  ...
  const isExtraLargeTabScreen = useMediaQuery("(width:912px)");
  const isBigTabScreen = useMediaQuery("(width: 800px), (width: 820px), (width: 853px),(width: 912px)"); // or (width:853px)
        ...
        <Grid
          ...
          sx={{
            ...
            padding: {
              ...
              sm: isExtraLargeTabScreen?"30px 0px 50px 130px":isTabScreen || isBigTabScreen ? "30px 0px 50px 70px" : "0px",
              ...
              >
                ...
                <Typography
                  ...
                  sx={{
                    ...
                    fontStyle: "italic",
                    fontSize: {
                      xs: isCardHovered === 1 ? "15px" : "13px",
                      sm: isCardHovered === 1 ? "20px" : "17px",
              ...
              >
                ...
                <Typography
                  ...
                  sx={{
                    ...
                    fontStyle: "italic",
                    fontSize: {
                      xs: isCardHovered === 2 ? "15px" : "13px",
                      sm: isCardHovered === 2 ? "20px" : "17px",
              ...
              >
                ...
                <Typography
                  ...
                  sx={{
                    ...
                    fontStyle: "italic",
                    fontSize: {
                      xs: isCardHovered === 3 ? "15px" : "13px",
                      sm: isCardHovered === 3 ? "20px" : "17px",
